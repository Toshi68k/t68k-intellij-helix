...
object HelixTextObjectActions {
    ...
    fun findTextObjectRange(editor: Editor, caret: Caret, inside: Boolean, objectChar: Char): Pair<Int, Int>? {
        ...
        return when (objectChar) {
            ...
            'T' -> HelixStructuralTextObjects.findTestRange(editor, caret, inside)
            'x' -> HelixStructuralTextObjects.findXmlElementRange(editor, caret, inside)
            'g' -> HelixStructuralTextObjects.findVcsChangeRange(editor, caret, inside)
