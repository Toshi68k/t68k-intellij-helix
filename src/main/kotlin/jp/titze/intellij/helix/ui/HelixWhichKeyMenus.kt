...
object HelixWhichKeyMenus {
    ...
    val spaceItems = listOf(
        ...
        WhichKeyItem("e", "File explorer", "Project"),
        WhichKeyItem(".", "Buffer directory explorer", "SelectInProject"),
        WhichKeyItem("g", "Changed file picker", "Git Changes"),
        ...
        WhichKeyItem("c", "Toggle line comment", "Comment"),
        WhichKeyItem("C", "Toggle block comment", "BlockComment"),
        WhichKeyItem("h", "Select references", "HighlightUsages"),
    ...
    val gotoItems = listOf(
        ...
        WhichKeyItem("i", "Goto implementation", "GotoImplementation"),
        ...
        WhichKeyItem("t", "Goto window top", "window_top"),
        WhichKeyItem("c", "Goto window center", "window_center"),
        WhichKeyItem("b", "Goto window bottom", "window_bottom"),
        WhichKeyItem("f", "Goto file at caret", "goto_file"),
        WhichKeyItem("|", "Goto column", "column <count>"),
