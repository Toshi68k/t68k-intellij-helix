...
object HelixWhichKeyMenus {
    ...
    val spaceItems = listOf(
        ...
        WhichKeyItem(".", "Buffer directory explorer", "file_explorer_buffer", "SelectInProjectView"),
        ...
        WhichKeyItem("D", "Workspace diagnostics", "workspace_diagnostics_picker", "ActivateProblemsViewToolWindow"),
        ...
        WhichKeyItem("h", "Select references", "select_references_to_symbol_under_cursor", "FindUsages"),
        ...
        WhichKeyItem("R", "Replace with clipboard", "replace_selections_with_clipboard"),
